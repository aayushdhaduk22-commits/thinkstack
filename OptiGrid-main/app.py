...
if st.session_state.get("optimized", False):
    ...
    with st.expander("🧠 How OptiGrid Optimizes Warehouses"):

        st.markdown("""
        OptiGrid uses a **K-Median-style optimization approach**.
        ...
        **4. Optimization**
        ...
        OptiGrid evaluates possible warehouse combinations and
        minimizes:
